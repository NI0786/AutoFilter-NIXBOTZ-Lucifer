...
from utils import get_settings, get_size, is_subscribed, save_group_settings, temp, verify_user, check_token, check_verification, get_token, send_all, get_status()
...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('• oᴘᴇɴ ɪɴ ᴘᴍ •', url="https://telegram.me/{}?start")
                 ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_text("ʟoᴀᴅɪɴɢ...")
